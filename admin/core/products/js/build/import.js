...
ImportScript.react.TableHead = React.createClass({displayName: "TableHead",
    render: function () {
        ...
        React.createElement("tr", null, 
            ...
            React.createElement("th", {width: "35%"}, 
...
ImportScript.react.TableRow = React.createClass({displayName: "TableRow",
    ...
    render: function () {
        ...
        React.createElement("tr", {id: element_id, "data-id": id, className: "record-item import-item", onClick: onClickFn}, 
            React.createElement("td", {className: "center"}, this.props.stt), 
            React.createElement("td", {className: "center"}, this.props.code), 
        ...
        return React.createElement("table", {className: "table table-bordered table-hover table-listing"}, 
            ...
            React.createElement("tr", {className: "footer"}, 
                React.createElement("td", {colSpan: "9"}, 
                    React.createElement("span", {class: "fl nowrap"}, "Tổng cộng ", React.createElement(FormattedNumber, {value: ImportScript.importList.length}), " nguyên liệu")
                )
            )
            )
        )
...
ImportScript.react.renderTableImport = function () {
    ...
    if (ImportScript.billInfo.debit) {
        ...
        React.render(React.createElement(FormattedNumber, {
            value: ImportScript.billInfo.totalMoney - ImportScript.billInfo.debitMoney}), $('#money-debit')[0]);
    }
    React.render(React.createElement(FormattedNumber, {value: ImportScript.billInfo.totalMoney}), ImportScript.domElement.totalMoney[0]);
