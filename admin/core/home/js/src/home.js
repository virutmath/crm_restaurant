...
var MenuList = React.createClass({
    render: function () {
        ...
        for (var i in props.list_category_menu) {
            ...
            rowLi.push(<MenuList.CategoryItem
                cat_id={data.cat_id}
...
HomeScript.view.buildListMenu = function () {
    React.render(<MenuList list_category_menu={HomeScript.listMenu}/>, HomeScript.domElement.listingMenu[0]);
};
